...
export const languageServerConfigs = {
  c: process.env.NEXT_PUBLIC_LSP_ENDPOINT_C,
  cpp: process.env.NEXT_PUBLIC_LSP_ENDPOINT_CPP,
};
...
export const content = `# A demo of \`react-markdown\`
